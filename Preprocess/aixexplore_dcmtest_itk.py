...
for name in names:
    print(name)
    dir_path = "D:\\ThyroidProject\\Data\\raw\\0416\\Aixplorer_Series\\%s\\DICOM\\PAT00001\\STU00001\\SER00001"%name
    ...
    if series_IDs:
        for series in series_IDs:
            ...
            for series_file_name in series_file_names:
                ...
                save_path1 = os.path.join("D:\\ThyroidProject\\Data\\temp\\0416\\jpg\\%s\\" % name)
                save_path = os.path.join("D:\\ThyroidProject\\Data\\temp\\0416\\%s\\" % name)
